...
FOR %%x IN ("D:\phpworkspaces\AppServ\www\NeoGraduationPro\configs\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\phpworkspaces\AppServ\www\NeoGraduationPro\configs\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\phpworkspaces\AppServ\www\NeoGraduationPro\configs"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\phpworkspaces\AppServ\php7\php.exe"
GOTO :INSTALLED
