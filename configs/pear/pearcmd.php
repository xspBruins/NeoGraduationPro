...
if ('D:\phpworkspaces\AppServ\www\NeoGraduationPro\configs\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\phpworkspaces\AppServ\www\NeoGraduationPro\configs\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
